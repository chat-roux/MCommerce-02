...
import com.mclientui.web.view.CommandeConfirmerView;
...
public class ClientControllerImpl implements ClientController {
	...
	private static final String MESSAGE__COMMANDE_CONFIRMER__COMMANDE_INTROUVABLE = "Confirmer une commande -- Commande introuvable";
    ...
    public String creerCommande(@PathVariable(name="produitId") Long pProduitId, Model pModel){
		...
		//     ->CAS NOMINAL : Le produit a été trouvé.
		//     ->TRAITEMENTS : 
		//        ->(03.01.)Créer un bean de vue 'commandeConfirmerView' (en alimentant ses attributs 'produitBean' et 'commandeBean').
		//        ->(03.02.)Ajouter le bean de vue dans le modèle.
		//////////////////////////////////////////////////////////////////////////////////////////////
		CommandeConfirmerView commandeConfirmerView = new CommandeConfirmerView(produitBean, commandeBean);
        pModel.addAttribute("commandeConfirmerView", commandeConfirmerView);
	 ...
	 */    
    @Override
    @RequestMapping(value="/commande/confirmer", method=RequestMethod.POST)
    public String confirmerCommande(@RequestParam(value="commandeId") Long pCommandeId
    							, @RequestParam(value="produitPrix") Double pProduitPrix
    							, @RequestParam(value="commandeQuantite") Integer pCommandeQuantite
    							, Model pModel){

		LOGGER.info("CLASS : ClientController -- METHOD : confirmerCommande -- BEGIN");
